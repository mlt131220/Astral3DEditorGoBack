...
CREATE TABLE `lb_3d_editor_scenes`  (
  `id` bigint(0) NOT NULL COMMENT '主键ID,雪花算法生成',
  ...
  `exampleSceneId` int(0) NULL DEFAULT NULL COMMENT '创建项目时来源于哪一个示例模板项目，null代表从空项目创建。（fk）',
...
CREATE TABLE `lb_3d_editor_scenes_example`  (
  ...
  `delTime` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci COMMENT = '新建场景时的示例表' ROW_FORMAT = Dynamic;
